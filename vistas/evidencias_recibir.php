            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 d-flex align-items-end">
                                <button id="applyFiltersPorRecibir" class="btn btn-primary w-100">Filtrar</button>
                            </div>
                            <div class="col-md-3 d-flex align-items-end">
                                <button id="btnVerTodosPorRecibir" class="btn btn-secondary w-100">Ver Todas</button>
                            </div>
                            <div id="filtros-aplicados" class="mt-3" style="display: flex; align-items: center;">
                    ...
                    <div class="d-flex justify-content-center" id="paginacion-container">
                        <nav>
                            <ul class="pagination" id="paginacion-evidencias-por-recibir"></ul>
                        </nav>
                    </div>
                    <div id="mensaje-registros-2" class="text-center"></div>
                    <div id="mis-evidencias-list-recibir" class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 m-2 mt-3">
