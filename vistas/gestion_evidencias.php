                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Todas las Evidencias</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="page-header-title">
                                <h4 class="mb-0">Todas las Evidencias</h4>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mt-0">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="estadoFilter" class="form-select" aria-label="Select Estado">
                            ...
                            <div class="col-md-2 d-flex align-items-end">
                                <button id="applyFilters" class="btn btn-secondary w-100">Ver Todas</button>
                            </div>
                    ...
                    <div id="mensaje-registros" class="text-center mt-3"></div>

                    <div id="mis-evidencias-list-todas" class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 m-2 mt-3">
